...
public class AnimationSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        AnimationComponent animationComponent = AllComponentsMap.animationComponentMapper.get(entity);
        TextureComponent textureComponent = AllComponentsMap.textureComponentMapper.get(entity);
